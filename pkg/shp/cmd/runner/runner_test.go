...
func (m *mockedSubCommand) Complete(_ *params.Params, _ *genericclioptions.IOStreams, _ []string) error {
	return nil
}
...
func (m *mockedSubCommand) Run(_ *params.Params, _ *genericclioptions.IOStreams) error {
	return nil
}
